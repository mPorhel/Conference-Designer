...
/**
 * This is the item provider adapter for a {@link conference.Day} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConferencePackage.Literals.DAY__NAME,
				 true,
				 false,
				 false,
	...
	protected void addTalksPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Day_talks_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Day_talks_feature", "_UI_Day_type"),
				 ConferencePackage.Literals.DAY__TALKS,
				 true,
				 false,
				 true,
				 null,
