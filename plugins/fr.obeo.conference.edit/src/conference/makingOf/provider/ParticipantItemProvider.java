...
/**
 * This is the item provider adapter for a {@link conference.makingOf.Participant} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ParticipantItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MakingOfPackage.Literals.PARTICIPANT__AGE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MakingOfPackage.Literals.PARTICIPANT__PERSON,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addAttitudePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Participant_attitude_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Participant_attitude_feature", "_UI_Participant_type"),
				 MakingOfPackage.Literals.PARTICIPANT__ATTITUDE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Participant_type") + " " + participant.getAge();
	}
