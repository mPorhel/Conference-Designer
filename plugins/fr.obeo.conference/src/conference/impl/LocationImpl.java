...
public class LocationImpl extends EObjectImpl implements Location {
	...
	protected EClass eStaticClass() {
		return ConferencePackage.Literals.LOCATION;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConferencePackage.LOCATION__NAME, oldName, name));
	}
	...
	public EList<Talk> getTalks() {
		if (talks == null) {
			talks = new EObjectWithInverseResolvingEList<Talk>(Talk.class, this, ConferencePackage.LOCATION__TALKS, ConferencePackage.TALK__LOCATION);
		}
		return talks;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ConferencePackage.LOCATION__TALKS:
