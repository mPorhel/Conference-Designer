...
public class DayImpl extends EObjectImpl implements Day {
	...
	public EList<Talk> getTalks() {
		if (talks == null) {
			talks = new EObjectWithInverseResolvingEList<Talk>(Talk.class, this, ConferencePackage.DAY__TALKS, ConferencePackage.TALK__DAY);
		}
		return talks;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ConferencePackage.DAY__TALKS:
