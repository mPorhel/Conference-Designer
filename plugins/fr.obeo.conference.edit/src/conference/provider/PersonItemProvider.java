...
/**
 * This is the item provider adapter for a {@link conference.Person} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Person_talks_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Person_talks_feature", "_UI_Person_type"),
				 ConferencePackage.Literals.PERSON__TALKS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConferencePackage.Literals.PERSON__NAME,
				 true,
				 false,
				 false,
	...
	protected void addOrganisationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Person_organisation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Person_organisation_feature", "_UI_Person_type"),
				 ConferencePackage.Literals.PERSON__ORGANISATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addTracksPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Person_tracks_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Person_tracks_feature", "_UI_Person_type"),
				 ConferencePackage.Literals.PERSON__TRACKS,
				 true,
				 false,
				 true,
				 null,
