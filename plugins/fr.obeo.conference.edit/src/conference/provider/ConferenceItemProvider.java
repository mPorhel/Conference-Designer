...
public class ConferenceItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ConferencePackage.Literals.CONFERENCE__TRACKS);
			childrenFeatures.add(ConferencePackage.Literals.CONFERENCE__SPEAKERS);
			childrenFeatures.add(ConferencePackage.Literals.CONFERENCE__DAYS);
			childrenFeatures.add(ConferencePackage.Literals.CONFERENCE__LOCATIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ConferencePackage.Literals.CONFERENCE__TRACKS,
				 ConferenceFactory.eINSTANCE.createTrack()));

		newChildDescriptors.add
			(createChildParameter
				(ConferencePackage.Literals.CONFERENCE__SPEAKERS,
				 ConferenceFactory.eINSTANCE.createPerson()));

		newChildDescriptors.add
			(createChildParameter
				(ConferencePackage.Literals.CONFERENCE__DAYS,
				 ConferenceFactory.eINSTANCE.createDay()));

		newChildDescriptors.add
			(createChildParameter
				(ConferencePackage.Literals.CONFERENCE__LOCATIONS,
				 ConferenceFactory.eINSTANCE.createLocation()));
	}
